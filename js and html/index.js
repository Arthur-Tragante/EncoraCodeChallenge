function numToWords() {
  ...
  if (amount.indexOf(" ") > -1) return "whitespaces not allowed"; //Validation for withe Spaces
  ...
  */
  result.innerHTML = arrayOfWords.filter((element) => element != undefined && element !== "").join(" ") + centsToPrint;
}
